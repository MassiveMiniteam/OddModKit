...
class NOISEGRAPHEDITOR_API SEdNode_NoiseGraphEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SEdNode_NoiseGraphEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UEdNode_NoiseGraphEdge* InNode);

...
struct FPackageReportNode
{
	...
	void ExpandChildrenRecursively(const TSharedRef<PackageReportTree>& Treeview, bool bOnlyChecked);
...
class SAssetDumpImporter : public SCompoundWidget
{
public:
	DECLARE_DELEGATE(FOnReportConfirmed)

	SLATE_BEGIN_ARGS( SAssetDumpImporter ){}
...
private:
	...
	FText SearchText;
    TArray<ReportPackageDataPtr> OriginalNodes;
